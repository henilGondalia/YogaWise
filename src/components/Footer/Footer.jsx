      ...
      <footer className="bg-white">
        <div className="container page-padding py-[10rem]">
          ...
          <div className="flex justify-between min620:flex-col min620:items-center min620:text-center min620:gap-[5rem] !text-left">
            {/* logo side */}
            <div className="flex flex-col w-1/3 gap-8 min620:w-2/3">
              <img
                src={FooterLogo}
                alt="footer_logo"
                className="w-[18rem] min620:w-full min620:justify-center"
              />
              <p className="text-[15px] font-medium text-[#646464] min620:text-center">
              ...
              {/* socials */}
              <div className="flex gap-7 text-[18px] text-[#646464] min620:justify-center">
                <i
              ...
              <p className="text-[16px] font-medium text-[#646464] min620:text-center">
