...
function ClassesBox({ bgImg, title, trainer, data }) {
  return (
    <>
      <div
        className={`${bgImg} rounded-3xl shadow-2xl flex flex-col h-[46rem] relative p-[35px]`}
      >
        ...
        <div className="flex flex-col align-text-bottom h-full w-full z-[2] justify-end">
          ...
          <div className="flex gap-6 mb-14 mt-6 text-[#ffffffe1] text-[1.6rem] font-medium">
            ...
            <p>
              <i className="fa-solid fa-laptop-file"></i> {data}
            </p>
          </div>
