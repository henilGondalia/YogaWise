...
import Trainer4 from "../../images/trainers/trainer4.png";
import Trainer5 from "../../images/trainers/trainer5.png";
import Trainer6 from "../../images/trainers/trainer6.png";
...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Ivorie Lewis", job: "Yoga & Meditation" },
    { img: Trainer2, name: "Jonathan Doe", job: "Yoga & Fitness" },
    { img: Trainer3, name: "Ana June", job: "Pilates & Fitness" },
    // { img: Trainer4, name: "Kia Miller", job: "Yin Yoga & Meditation" },
    // { img: Trainer5, name: "Alex Artymiak", job: "Pilates & Fitness" },
    // { img: Trainer6, name: "Jo Tastula", job: "Hatha & Meditation" },
  ];
        ...
        {trainers.map((train, id) => (
          ...
          >
            ...
            <img
              ...
              className={`w-[22rem] z-10 relative grayscale mx-auto  top-[5px] ${
